...
export default function App() {
	...
	// Use fallback data if tourData is not loaded yet
	const imageUrl = tourData?.imageUrl || "https://www.tclf.org/sites/default/files/thumbnails/image/HarvardUniversity-sig.jpg";
	const voiceUrl = tourData?.voiceUrl || "https://github.com/rafaelreis-hotmart/Audio-Sample-files/raw/master/sample.mp3";
