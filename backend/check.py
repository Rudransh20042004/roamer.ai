...
MAPS_API_KEY = os.getenv("MAPS_API_KEY", "AlzaSyD78F2NJJFgkamEK9gOevznVBAN0HcBо3Е")
...
def speech(msg):
    #load_dotenv()
    api_key = os.getenv("ELEVEN_API_KEY") or "sk_f97508bc90abc6598e9eab4339e1d1ba212a05e71c030533"
    #if not api_key:
